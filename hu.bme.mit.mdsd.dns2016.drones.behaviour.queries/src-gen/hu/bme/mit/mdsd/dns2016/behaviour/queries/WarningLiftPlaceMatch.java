...
/**
 * Pattern-specific match representation of the hu.bme.mit.mdsd.dns2016.behaviour.queries.warningLiftPlace pattern,
 * to be used in conjunction with {@link WarningLiftPlaceMatcher}.
 * 
...
public abstract class WarningLiftPlaceMatch extends BasePatternMatch {
  private DroneBehaviour fDb;
  
  private static List<String> parameterNames = makeImmutableList("db");
  
  private WarningLiftPlaceMatch(final DroneBehaviour pDb) {
    this.fDb = pDb;
  }
  ...
  public List<String> parameterNames() {
    return WarningLiftPlaceMatch.parameterNames;
  }
  ...
  @Override
  public WarningLiftPlaceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WarningLiftPlaceMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WarningLiftPlaceMatch other = (WarningLiftPlaceMatch) obj;
  ...
  @Override
  public WarningLiftPlaceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WarningLiftPlaceMatch newEmptyMatch() {
   ...
   * 
   */
  public static WarningLiftPlaceMatch newMutableMatch(final DroneBehaviour pDb) {
   ...
   * 
   */
  public static WarningLiftPlaceMatch newMatch(final DroneBehaviour pDb) {
    return new Immutable(pDb);
  }
  
  private static final class Mutable extends WarningLiftPlaceMatch {
  ...
  private static final class Immutable extends WarningLiftPlaceMatch {
