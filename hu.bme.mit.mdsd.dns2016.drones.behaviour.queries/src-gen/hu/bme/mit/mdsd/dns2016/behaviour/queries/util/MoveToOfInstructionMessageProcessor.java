...
/**
 * A match processor tailored for the hu.bme.mit.mdsd.dns2016.behaviour.queries.moveToOfInstructionMessage pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class MoveToOfInstructionMessageProcessor implements IMatchProcessor<MoveToOfInstructionMessageMatch> {
  /**
  ...
  @Override
  public void process(final MoveToOfInstructionMessageMatch match) {
    process(match.getMt());
  }
}
