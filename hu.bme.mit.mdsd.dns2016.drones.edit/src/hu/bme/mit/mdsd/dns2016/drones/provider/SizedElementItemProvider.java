...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.mdsd.dns2016.drones.SizedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SizedElementItemProvider 
	 ...
	 * @generated
	 */
	public SizedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SizedElement"));
	}
	...
	public String getText(Object object) {
		SizedElement sizedElement = (SizedElement)object;
		return getString("_UI_SizedElement_type") + " " + sizedElement.getLength();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SizedElement.class)) {
	...
	public ResourceLocator getResourceLocator() {
		return DronesEditPlugin.INSTANCE;
	}
