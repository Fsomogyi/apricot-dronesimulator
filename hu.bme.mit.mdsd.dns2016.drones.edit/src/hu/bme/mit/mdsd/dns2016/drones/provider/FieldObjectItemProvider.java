...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.mdsd.dns2016.drones.FieldObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldObjectItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FieldObjectItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DronesPackage.Literals.FIELD_OBJECT__PARAMETERS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FieldObject"));
	}
	...
	public String getText(Object object) {
		String label = ((FieldObject)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FieldObject_type") :
			getString("_UI_FieldObject_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FieldObject.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DronesPackage.Literals.FIELD_OBJECT__PARAMETERS,
