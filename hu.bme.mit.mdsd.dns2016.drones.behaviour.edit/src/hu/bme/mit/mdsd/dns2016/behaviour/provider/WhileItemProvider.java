...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.mdsd.dns2016.behaviour.While} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileItemProvider extends InstructionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviourPackage.Literals.WHILE__CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviourPackage.Literals.WHILE__INSTRUCTIONS);
			childrenFeatures.add(BehaviourPackage.Literals.WHILE__CONDITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(While.class)) {
			case BehaviourPackage.WHILE__INSTRUCTIONS:
			case BehaviourPackage.WHILE__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviourPackage.Literals.WHILE__INSTRUCTIONS,
