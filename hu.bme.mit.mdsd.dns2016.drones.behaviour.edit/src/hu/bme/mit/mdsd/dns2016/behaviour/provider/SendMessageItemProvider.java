...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.mdsd.dns2016.behaviour.SendMessage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SendMessageItemProvider extends InstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SendMessage_messageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SendMessage_messageType_feature", "_UI_SendMessage_type"),
				 BehaviourPackage.Literals.SEND_MESSAGE__MESSAGE_TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((SendMessage)object).getMessageType();
